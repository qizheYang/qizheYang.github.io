...
const Portfolio: React.FC = () => {
    ...
    return (
        <div className="container">
            <h1>{t("Portfolio", "作品集")}</h1>

            {/* 3D Modeling & Animation */}
            <section className="skills-section">
                <h2>{t("3D Modeling & Animation", "3D 建模与动画")}</h2>
            ...
            {/* Computer Graphics */}
            <section className="skills-section">
                <h2>{t("Computer Graphics", "计算机图形学")}</h2>
                <div className="project-list">
                    <div className="portfolio-block">
                        <p>
                            {t(
                ...
                <div className="project-list">
                    <div className="portfolio-block">
                        ...
                        <p>
                            ...
                            <a href="/pdf_files/ib_geo_ee.pdf" target="_blank" rel="noopener noreferrer">
                                {t("View PDF", "查看 PDF")}
                            </a>
                        </p>
                        ...
                        <p>
                            ...
                            <a href="/pdf_files/envi_si.pdf" target="_blank" rel="noopener noreferrer">
                                {t("View PDF", "查看 PDF")}
                            </a>
                        </p>
                        ...
                        <p>
                            ...
                            <a href="/pdf_files/basement.pdf" target="_blank" rel="noopener noreferrer">
                                {t("View PDF", "查看 PDF")}
                            </a>
                        </p>
                    </div>
